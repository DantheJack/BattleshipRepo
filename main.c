...
// | Quand un joueur reçoit cette requete, il va creer
...
// | Quand un joueur reçoit cette requete, il va definir
...
// | Le serveur, après avoir demande un tir à J1, va
// | transmettre les coordonnees du tir à J2, afin que
